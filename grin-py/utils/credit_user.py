...
FLOOPOOL_MYSQL_ADDR = "35.185.226.16"
BITGRIN_MYSQL_ADDR = "34.76.50.243"
MWGRINPOOL_MYSQL_ADDR = "35.230.77.123"
...
print("2) BitGrin")
print("3) MWGrinPool")
pool = input("Choose Pool: ")
db_password = getpass.getpass("MySQL Password: ")

if pool == "1":
    db_host = FLOOPOOL_MYSQL_ADDR
    poolname = "FlooPool"
elif pool == "2":
    db_host = BITGRIN_MYSQL_ADDR
    poolname = "BitGrin"
elif pool == "3":
    db_host = MWGRINPOOL_MYSQL_ADDR
    poolname = "MWGrinPool"
else:
    print("Invalid Pool choice: {}".format(pool))
    sys.exit(1)
